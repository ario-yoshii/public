                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m">
                        <h2 class="mttls tac mb18 smb12">
                            <span class="mttls_en en">ROYAL SUITE</span>
                            <span class="mttls_ja">ロイヤルスイート</span>
                        </h2>
                        <div class="ptb_sps pt0 pb0 inner_sb sp_inner_b">
                            <div class="imgslidesA mb30 smb25">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/royal-suite/img_royal-suite1.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/royal-suite/img_royal-suite2.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/royal-suite/img_royal-suite3.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/royal-suite/img_royal-suite4.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/royal-suite/img_royal-suite5.jpg" alt=""></figure>
                            </div>
                            <h2 class="read_ttl ja-min tac mb15 sp_sps smb20">鹿児島のシンボル「桜島」を中心に、<br class="onlySp">壮大な景色が一望できるスイートルーム</h2>
                            <p class="tac sp_tal">

                                本館12階エグゼクティブフロアに位置するスイートルーム。<br class="onlyPc">
                                エアウィーヴマットレス、デュベタイプの寝具で快適な寝心地とマイクロナノバブルシャワーヘッド、<br class="onlyPc">
                                こだわりのヘアドライヤー（ヘアビューザー）を設置。快適でラグジュアリーなご滞在をお約束致します。<br>
                                （全1室禁煙ルームとなります）
                            </p>
                        </div>
                    </div>
                    <div class="ptb_sps pt60 spt40 spb20 inner_sb">
                        <article class="mb30 smb20">
                            ...
                            <dl class="dl_tnses_b">
                                ...
                                <dd>
                                    <div class="flex_left">
                                        <span class="pt4 mr15">97.5㎡</span>
                                        <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/royal-suite/img_royal-suite_layout.png" class="btn_floormap bg_gray a_md no_md_icon"><span>間取り図</span></a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="dl_tnses_b">
                            ...
                            <dl class="dl_tnses_b">
                                <dt>料金</dt>
                                <dd>2名様1室　132,300円～<br><span class="fs12">※表示価格は通常料金になり、税金・サービス料が含まれております。</span></dd>
                            </dl>
                        </article>
                    ...
                    <div class="ptb_sps pt32 pb70 spb30 inner_sb">
                        ...
                        <article class="mdbtnset">
                            ...
                            <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/royal-suite/img_royal-suite6.jpg" class="a_md"><span><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/royal-suite/img_royal-suite6s.jpg" alt=""></span></a>
                        </article>
                    </div>
                </section>
