<?php
/*
Template Name: ご宿泊 - エグゼクティブツインBタイプ 本館
*/
?>
<?php get_header(); ?>
                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m">
                        <h2 class="mttls tac mb18 smb12">
                            <span class="mttls_en en">EXECUTIVE TWIN B</span>
                            <span class="mttls_ja">エグゼクティブツインBタイプ</span>
                        </h2>
                        <div class="ptb_sps pt0 pb0 inner_sb sp_inner_b">
                            <div class="imgslidesA mb30 smb25">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/executive-twin-b/img_executive-twin-b1.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/executive-twin-b/img_executive-twin-b2.jpg" alt=""></figure>
                            </div>
                            <h2 class="read_ttl ja-min tac mb15 sp_sps smb20">高層階に位置するワンランク上、<br class="onlySp">3名様定員のツインルーム</h2>
                            <p class="tac sp_tal">
								
								本館10～12階のエグゼクティブフロアに位置する3名様定員の広めのツインルーム。<br class="onlyPc">エアウィーヴマットレス、デュベタイプの寝具で快適な寝心地とマイクロナノバブルシャワーヘッド、<br class="onlyPc">こだわりのヘアドライヤー（ヘアビューザー）を設置。快適なご滞在をお約束致します。<br>
								（禁煙ルームのみ）
                            </p>
                        </div>
                    </div>
                    <div class="ptb_sps pt60 spt40 spb20 inner_sb">
                        <article class="mb30 smb20">
                            ...
                            <dl class="dl_tnses_b">
                                ...
                                <dd>
                                    <div class="flex_left">
                                        <span class="pt4 mr15">31.3㎡</span>
                                        <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/executive-twin-b/img_executive-twin-b_layout.png" class="btn_floormap bg_gray a_md no_md_icon"><span>間取り図</span></a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="dl_tnses_b">
                                <dt>ベッド幅</dt>
                                <dd>1,100mm 2台<br>(3名利用時はソファベッドとなります)</dd>
                            </dl>
                            <dl class="dl_tnses_b">
                                <dt>フロア</dt>
                                <dd>本館10～12階</dd>
                            ...
                            <dl class="dl_tnses_b">
                                <dt>料金</dt>
                                <dd>2名様1室　30,550円～<br><span class="fs12">※表示価格は通常料金になり、税金・サービス料が含まれております。</span></dd>
                            </dl>
                        </article>
