...
<div id="wrapper"><!-- #wrapper -->
    ...
    <main id="maincontainer" class="container"><!-- #maincontainer -->
        ...
        <div class="main_bloc">
            ...
            <section id="lkv" data-image="<?php bloginfo('template_directory'); ?>/assets/images/banquet/bouquet/lkv_img_bouquet.jpg"><!-- #kv -->
                <h1 class="lkv_bttls">
                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m sp_inner_b">
                        <h2 class="mttls tac mb18 smb12">
                            ...
                            <span class="mttls_ja">ブーケ・ガーランド</span>
                        </h2>
                        <article class="tslide_container">
                            <div class="tslide_ibox imgslidesB">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/banquet/bouquet/img_bouquet01.jpg"></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/banquet/bouquet/img_bouquet02.jpg"></figure>
                            </div>
                            <div class="tslide_tbox">
                                <div class="tslide_tbox_inner">
                                    ...
                                    <p class="tslide_tbox_txt">
										婚礼はもちろん、宴会、会議、展示会、2次会などさまざまなシチュエーションにご利用いただけます。
                                    </p>
                                </div>
                            </div>
                        </article>
                    ...
                    <div class="ptb_sps pt10 pb70 spb30 inner_sb">
                        ...
                        <article class="mdbtnset">
                            <a href="<?php bloginfo('template_directory'); ?>/assets/images/banquet/bouquet/img_list_bouquet01.jpg" class="a_md"><span><img src="<?php bloginfo('template_directory'); ?>/assets/images/banquet/bouquet/img_list_bouquet01_thumb.jpg" alt=""></span></a>
                            <a href="<?php bloginfo('template_directory'); ?>/assets/images/banquet/bouquet/img_list_bouquet02.jpg" class="a_md"><span><img src="<?php bloginfo('template_directory'); ?>/assets/images/banquet/bouquet/img_list_bouquet02_thumb.jpg" alt=""></span></a>
                        </article>
                    </div>
                </section>
