                    ...
                    <div class="ptb_sps pt0 pb120 spb60 inner_m">
                        <article class="bnr_container">
                            <div class="bnr_item bnr_item_m">
                                ...
                                <a href="<?php bloginfo('url'); ?>/cn/accommodations/" class="hitarea"></a>
                            </div>
                            <div class="bnr_item bnr_item_m">
                                ...
                                <a href="<?php bloginfo('url'); ?>/cn/restaurant/" class="hitarea"></a>
                            </div>
                            <div class="bnr_item bnr_item_s">
                                ...
                                <a href="<?php bloginfo('url'); ?>/cn/relaxation/" class="hitarea"></a>
                            </div>
                            <div class="bnr_item bnr_item_s">
                                ...
                                <a href="<?php bloginfo('url'); ?>/cn/company/" class="hitarea"></a>
                            </div>
                            <div class="bnr_item bnr_item_s">
                                <figure class="bnr_item_img"><span data-image="<?php bloginfo('template_directory'); ?>/assets/images/img_info_access.jpg"></span></figure>
                                <h2 class="w_bttls tac">
                                    <span class="mttls_en en">访问</span>
                                </h2>
                                <a href="<?php bloginfo('url'); ?>/cn/access/" class="hitarea"></a>
                            </div>
