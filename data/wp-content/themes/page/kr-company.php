    ...
    <main id="maincontainer" class="container"><!-- #maincontainer -->
        ...
        <div class="main_bloc">
            ...
            <section id="lkv" data-image="<?php bloginfo('template_directory'); ?>/assets/images/access/lkv_img_access@2x.jpg"><!-- #kv -->
                <h1 class="lkv_bttls">
                    <span class="mttls_en en">호텔 소개</span>
                </h1>
            </section><!-- /#kv -->
                    ...
                    <div class="inner_m">
                        <div class="ptb_sps pt0 pb80 spb40 inner_sb sp_inner_b">
                            ...
                            <p class="tac sp_tal mb83 smb40">
								호텔 쿄세라는 추억을 담는 만남의 장소로서 객실 시설 외 레스토랑, 온천, 웨딩, 컨벤션, 어뮤즈먼트 스파 등의 다양한 부대시설을 갖추고 있습니다. ‘고객사랑’을 테마로 설립된 즐거움과 감동이 넘치는 호텔 쿄세라는 일본의 ‘오모테나시’ 서비스 정신을 토대로 방문해주시는 고객 한 분 한 분을 환한 미소로 맞이하고 있습니다.<br>
								※오모테나시: 일본의 고객 서비스의 기본 바탕으로서 ‘환대’의 의미를 지닌다.
                            </p>

                            <article>
                                <dl class="dl_tnses_b">
                                    <dt>회사명</dt>
                                    <dd>호텔 쿄세라 Hotel Kyocera Corporation</dd>
                                </dl>
                                <dl class="dl_tnses_b">
                                    <dt>주소</dt>
                                    <dd>〒899-5117 일본 가고시마현 키리시마시 하야토쵸 미츠기 1409-1</dd>
                                </dl>
                                <dl class="dl_tnses_b">
                                    <dt>대표전화&팩스</dt>
                                    <dd>
                                ...
                                <dl class="dl_tnses_b">
                                    ...
                                    <dd>
										도쿄 영업소<br>
										〒150-0001 　일본 도쿄도 시부야구 징구마에 6-27-8 쿄세라 하라쥬쿠 빌딩 지하1층
                                    </dd>
                                </dl>
                                <dl class="dl_tnses_b">
