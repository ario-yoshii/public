                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m">
                        <h2 class="mttls tac mb18 smb12">
                            <span class="mttls_en en">JAPANESE ROOM</span>
                            <span class="mttls_ja">和室</span>
                        </h2>
                        <div class="ptb_sps pt0 pb0 inner_sb sp_inner_b">
                            <div class="imgslidesA mb30 smb25">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese/img_japanese1.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese/img_japanese2.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese/img_japanese3.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese/img_japanese4.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese/img_japanese5.jpg" alt=""></figure>
                            </div>
                            <h2 class="read_ttl ja-min tac mb15 sp_sps smb20">8畳、6畳の続き間でゆっくりとお過ごしいただけます</h2>
                            <p class="tac sp_tal">
								別館8階に位置する、6名定員の和室。<br>
								（全2室禁煙ルームとなります）
                            </p>
                        </div>
                    </div>
                    <div class="ptb_sps pt60 spt40 spb20 inner_sb">
                        <article class="mb30 smb20">
                            ...
                            <dl class="dl_tnses_b">
                                <dt>定員</dt>
                                <dd>1名～6名<br>和布団6組まで準備可能</dd>
                            </dl>
                            <dl class="dl_tnses_b">
                                <dt>広さ</dt>
                                <dd>
                                    <div class="flex_left">
                                        <span class="pt4 mr15">6畳＋8畳</span>
                                        <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese/img_japanese_layout.png?v=20211006" class="btn_floormap bg_gray a_md no_md_icon"><span>間取り図</span></a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="dl_tnses_b">
                            ...
                            <dl class="dl_tnses_b">
                                <dt>料金</dt>
                                <dd>2名様1室　42,100円～<br><span class="fs12">※表示価格は通常料金になり、税金・サービス料が含まれております。</span></dd>
                            </dl>
                        </article>
                    ...
                    <div class="ptb_sps pt32 pb70 spb30 inner_sb">
                        ...
                        <article class="mdbtnset">
                            ...
                            <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese/img_japanese6.jpg" class="a_md"><span><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese/img_japanese6s.jpg" alt=""></span></a>
                        </article>
                    </div>
