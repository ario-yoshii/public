...
京はるかの「逸品」料理とともにお愉しみください。
						...
						?>
							...
							<?php
								if ($thisCatA->count != 0 ) :?>
									<a href="<?php bloginfo('url'); ?>/info/restaurant/kyoharuka/kyoharuka-lunch/" class="itbox_item">
							...
							<?php
								if ($thisCatB->count != 0 ) :?>
									<a href="<?php bloginfo('url'); ?>/info/restaurant/kyoharuka/kyoharuka-dinner/" class="itbox_item">
										<div class="itbox_item_inner">
											<figure class="itbox_item_img">
							...
							<?php
								if ($thisCatC->count != 0 ) :?>
									<a href="<?php bloginfo('url'); ?>/info/restaurant/kyoharuka/kyoharuka-planning/" class="itbox_item">
										<div class="itbox_item_inner">
											<figure class="itbox_item_img">
							...
							<?php
								if ($thisCatD->count != 0 ) :?>
									<a href="<?php bloginfo('url'); ?>/info/restaurant/kyoharuka/kyoharuka-concluding/" class="itbox_item">
										<div class="itbox_item_inner">
											<figure class="itbox_item_img">
                    ...
                    <div class="ptb_sps pb60 spb60 inner_m sp_inner_b">
                        ...
                        <a href="<?php bloginfo('url'); ?>/info/restaurant/kyoharuka/" class="txtbtn mauto smt15"><span>京はるかの情報一覧</span></a>
                    </div>
                </section>
