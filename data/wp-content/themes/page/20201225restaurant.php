                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb45 spb30 bd_btm inner_m sp_inner_b">
                        ...
                        <nav class="btns sp_nowrap sort_evt mb50 smb15 spl20">
                            <a href="#" class="roundbtn btnbg_w" data-target="cat_new"><span>全て</span></a>
                        ...
                        <article class="info_container mb30" data-maxview=6>
							...
							'category_name' => 'restaurant' // 表示したいカテゴリーのスラッグを指定
							);
							$posts = get_posts( $arg );
							if( $posts ): ?>
							...
							'orderby' => 'date', // 日付でソート
							'order' => 'DESC', // DESCで最新から表示、ASCで最古から表示
							'category_name' => 'delsole' // 表示したいカテゴリーのスラッグを指定
							);
							$posts = get_posts( $arg );
							if( $posts ): ?>
							<?php foreach ( $posts as $post ) : setup_postdata( $post ); ?>
							...
							'orderby' => 'date', // 日付でソート
							'order' => 'DESC', // DESCで最新から表示、ASCで最古から表示
							'category_name' => 'kyoharuka' // 表示したいカテゴリーのスラッグを指定
							);
							$posts = get_posts( $arg );
							if( $posts ): ?>
							<?php foreach ( $posts as $post ) : setup_postdata( $post ); ?>
							...
							'orderby' => 'date', // 日付でソート
							'order' => 'DESC', // DESCで最新から表示、ASCで最古から表示
							'category_name' => 'amore' // 表示したいカテゴリーのスラッグを指定
							);
							$posts = get_posts( $arg );
							if( $posts ): ?>
							<?php foreach ( $posts as $post ) : setup_postdata( $post ); ?>
                        ...
                        <a href="<?php bloginfo('url'); ?>/info/restaurant/" class="txtbtn mauto smt15"><span>その他のレストラン情報一覧</span></a>
                    </div>
                </section>
                                    ...
                                    <div class="itd_item_tbox_en">
                                        ...
                                        <dl class="openhours">
                                            ...
                                            <dd>
                                                ...
                                                <span class="hourbox">ディナー</span>通　常：17:30～20:00（L.O. 19:00）<br>　　　　　 土曜日：17:30～21:00（L.O. 19:30）
                                            </dd>
                                        </dl>
										<dl class="openhours">
                                            <dt>定休日</dt>
                                    ...
                                    <div class="itd_item_tbox_en">
                                        ...
                                        <dl class="openhours">
                                            ...
                                            <dd>
                                                ...
                                                <span class="hourbox">ディナー</span>通　常：17:00～20:00（L.I. 19:00）<br>　　　　　 土曜日：17:00～21:00（L.I. 20:00）<br>
                                            </dd>
										</dl>
										<dl class="openhours">
                                            <dt>定休日</dt>
