<?php
/*
Template Name: ご宿泊 - エグゼクティブコンフォートツイン 本館
*/
?>
<?php get_header(); ?>
                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m">
                        <h2 class="mttls tac mb18 smb12">
                            <span class="mttls_en en">EXECUTIVE COMFORT TWIN</span>
                            <span class="mttls_ja">エグゼクティブコンフォートツイン</span>
                        </h2>
                        <div class="ptb_sps pt0 pb0 inner_sb sp_inner_b">
                            <div class="imgslidesA mb30 smb25">
                                ...
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/executive-comfort-twin/img_executive-comfort-twin2.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/executive-comfort-twin/img_executive-comfort-twin3.jpg" alt=""></figure>
                            </div>
                            <h2 class="read_ttl ja-min tac mb15 sp_sps smb20">上層階にあり、ご滞在中のゆとりの時間と空間をお約束いたします</h2>
                            <p class="tac sp_tal">
                                本館12階のエグゼクティブフロアに位置する2名様定員のツインルーム。<br>
                                エアウィーヴマットレス、デュベタイプの寝具で快適な寝心地とマイクロナノバブルシャワーヘッド、<br class="onlyPc">こだわりのヘアドライヤー（ヘアビューザー）を設置。<br>
                                他ツインと異なり中扉が御座いませんので、広々と快適なご滞在をお約束致します。<br>
                                禁煙ルームのみのお部屋タイプになります。
                            </p>
                        </div>
                    </div>
                            ...
                            <dl class="dl_tnses_b">
                                ...
                                <dd>
                                    <div class="flex_left">
                                        ...
                                        <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/executive-comfort-twin/img_executive-comfort-twin_layout.png?20210614" class="btn_floormap bg_gray a_md no_md_icon"><span>間取り図</span></a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="dl_tnses_b">
