...
<div id="wrapper"><!-- #wrapper -->
    ...
    <main id="maincontainer" class="container"><!-- #maincontainer -->
        ...
        <div class="main_bloc">
            ...
            <section id="lkv" data-image="<?php bloginfo('template_directory'); ?>/assets/images/banquet/southerncross/lkv_img_southerncross@2x.jpg"><!-- #kv -->
                <h1 class="lkv_bttls">
                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m sp_inner_b">
                        <h2 class="mttls tac mb18 smb12">
                            ...
                            <span class="mttls_ja">サザンクロス</span>
                        </h2>
                        <article class="tslide_container">
                            <div class="tslide_ibox imgslidesB">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/banquet/southerncross/img_southerncross01.jpg"></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/banquet/southerncross/img_southerncross02.jpg"></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/banquet/southerncross/img_southerncross03.jpg"></figure>
                            </div>
                            <div class="tslide_tbox">
                                <div class="tslide_tbox_inner">
                                    <h2 class="tslide_tbox_ttl ja-min">
										ホテル最上階から、館内に広がる大アトリウム空間と錦江湾に浮かぶ桜島の眺望が一度に楽しめるバンケットルーム
                                    </h2>
                                    <p class="tslide_tbox_txt">
										フレンチによるウェディングはもちろん、宴会、2次会など、様々なシーンにご活用ください。
                                    </p>
                                </div>
                            </div>
                        </article>
                    ...
                    <div class="ptb_sps pt10 pb70 spb30 inner_sb">
                        ...
                        <article class="mdbtnset">
                            <a href="<?php bloginfo('template_directory'); ?>/assets/images/banquet/southerncross/img_list_southerncross01.jpg" class="a_md"><span><img src="<?php bloginfo('template_directory'); ?>/assets/images/banquet/southerncross/img_list_southerncross01_thumb.jpg" alt=""></span></a>
                            <a href="<?php bloginfo('template_directory'); ?>/assets/images/banquet/southerncross/img_list_southerncross02.jpg" class="a_md"><span><img src="<?php bloginfo('template_directory'); ?>/assets/images/banquet/southerncross/img_list_southerncross02_thumb.jpg" alt=""></span></a>
                        </article>
                    </div>
                </section>
                    ...
                    <article class="inner_sb pb80 spb60 sp_inner_b">
                        <table class="sp_ofx mb10">
                            <tbody>
                                ...
                                <tr>
                                    <th colspan="1" width="33">本<br>
                                    館</th>
                                    <td>宴会場<br>TOPF</td>
                                    <td colspan="2">サザンクロス</td>
                                    <td>165</td>
                                    <td>50</td>
                                    <td>2.5</td>
                                    <td>50</td>
