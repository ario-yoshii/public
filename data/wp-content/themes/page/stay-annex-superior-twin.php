                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m">
                        ...
                        <div class="ptb_sps pt0 pb0 inner_sb sp_inner_b">
                            <div class="imgslidesA mb30 smb25">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/annex-superior-twin/img_annex-superior-twin1.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/annex-superior-twin/img_annex-superior-twin2.jpg" alt=""></figure>
                            </div>
                            <h2 class="read_ttl ja-min tac mb15 sp_sps smb20">定員3名、32.1平米のスーペリアツインルーム</h2>
                            <p class="tac sp_tal">
								別館にございます。3名利用時もゆったりお過ごしいただけます。<br>
								（禁煙ルームのみ）
                            </p>
                        </div>
                    </div>
                    <div class="ptb_sps pt60 spt40 spb20 inner_sb">
                        <article class="mb30 smb20">
                            ...
                            <dl class="dl_tnses_b">
                                ...
                                <dd>
                                    <div class="flex_left">
                                        <span class="pt4 mr15">32.1㎡</span>
                                        <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/annex-superior-twin/img_annex-superior-twin_layout.png" class="btn_floormap bg_gray a_md no_md_icon"><span>間取り図</span></a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="dl_tnses_b">
                            ...
                            <dl class="dl_tnses_b">
                                <dt>料金</dt>
                                <dd>2名様1室　24,500円～<br><span class="fs12">※表示価格は通常料金になり、税金・サービス料が含まれております。</span></dd>
                            </dl>
                        </article>
                    ...
                    <div class="ptb_sps pt32 pb70 spb30 inner_sb">
                        ...
                        <article class="mdbtnset">
                            ...
                            <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/annex-superior-twin/img_annex-superior-twin3.jpg" class="a_md"><span><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/annex-superior-twin/img_annex-superior-twin3s.jpg" alt=""></span></a>
                        </article>
                    </div>
                </section>
