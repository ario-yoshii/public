<?php
/*
Template Name: ご宿泊 - スタンダードツイン 別館
*/
?>
<?php get_header(); ?>
                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m">
                        <h2 class="mttls tac mb18 smb12">
                            <span class="mttls_en en">STANDARD TWIN ROOM</span>
                            <span class="mttls_ja">スタンダードツインルーム</span>
                        </h2>
                        <div class="ptb_sps pt0 pb0 inner_sb sp_inner_b">
                            <div class="imgslidesA mb30 smb25">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/annex-twin/img_annex-twin1.jpg" alt=""></figure>
                            </div>
                            <h2 class="read_ttl ja-min tac mb15 sp_sps smb20">25.5平米の広さでゆったりとお寛ぎいただけます</h2>
                            <p class="tac sp_tal">
								別館にございます、スタンダードタイプのツインルーム。<br>
								3名様までご利用可能なスーペリアタイプのご用意もございます。<br>
								（禁煙ルームのみ）
                            </p>
                        </div>
                    </div>
                    <div class="ptb_sps pt60 spt40 spb20 inner_sb">
                        <article class="mb30 smb20">
                            ...
                            <dl class="dl_tnses_b">
                                ...
                                <dd>
                                    <div class="flex_left">
                                        <span class="pt4 mr15">25.5㎡</span>
                                        <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/annex-twin/img_annex-twin_layout.png" class="btn_floormap bg_gray a_md no_md_icon"><span>間取り図</span></a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="dl_tnses_b">
                            ...
                            <dl class="dl_tnses_b">
                                <dt>料金</dt>
                                <dd>2名様1室　19,550円～<br><span class="fs12">※表示価格は通常料金になり、税金・サービス料が含まれております。</span></dd>
                            </dl>
                        </article>
