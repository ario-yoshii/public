<?php
/*
Template Name: English - ACCOMMODATIONS
*/
?>
<?php get_header(); ?>
                ...
                <section class="content">
                    <div class="inner_m bd_btm">
                        <div class="ptb_sps pt0 pb80 spb40 inner_sb sp_inner_b">
                            ...
                            <p class="tac sp_tal">
Scenic views from the various 328 guest rooms look out over the sprawling natural beauty of the Kagoshima region. <br>
Our guest rooms simultaneously present you with the comfort of your own home and the relaxation of a luxury hotel. <br>
Gentle white and ivory interior design and refined décor provide a true resort experience.
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="room_points_container">
                            <article id="room_points_item01" class="room_points_item">
                                <div class="room_points_item_inner">
                                    <h4 class="room_points_ttl en">328 rooms</h4>
                                    <p>245 non-smoking rooms</p>
                                </div>
                            </article>
                            ...
                            <article>
                                <div class="imgbox_typeD">
                                    ...
                                    <dl class="imgbox_dlset">
                                        <dt>SINGLE</dt>
                                        <dd>Simple yet sophisticated single room features a wide semi-double bed and writing desk, the perfect space for business trips.</dd>
                                    </dl>
                                </div>
                                <div class="imgbox_typeD">
                                    ...
                                    <dl class="imgbox_dlset">
                                        <dt>TWIN & TRIPLE</dt>
                                        <dd>Whether traveling for business or pleasure, our adaptable twin rooms present you with an open atmosphere for your resort experience in Kirishima. Spacious twin rooms are also available for three people.</dd>
                                    </dl>
                                </div>
                                <div class="imgbox_typeD">
                                    ...
                                    <dl class="imgbox_dlset">
                                        <dt>SUITE</dt>
                                        <dd>Suites offer the grand view of Kagoshima’s symbolic Mt. Sakurajima. The suite’s atmosphere exudes the highest quality, granting a respite from daily life and allowing you to relax in mind and body.<br>
Suite consists of a guest room, bedroom, bathroom, kitchen, and jacuzzi (royal suite room only)</dd>
                                    </dl>
                                </div>
                            </article>
                        </div>
