<?php
/*
Template Name: ご宿泊 - エグゼクティブシングル 本館
*/
?>
<?php get_header(); ?>
                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m">
                        <h2 class="mttls tac mb18 smb12">
                            <span class="mttls_en en">EXECUTIVE SINGLE ROOM</span>
                            <span class="mttls_ja">エグゼクティブシングシングルルーム</span>
                        </h2>
                        <div class="ptb_sps pt0 pb0 inner_sb sp_inner_b">
                            <div class="imgslidesA mb30 smb25">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/executive-single/img_executive-single1.jpg" alt=""></figure>
                            </div>
                            <h2 class="read_ttl ja-min tac mb15 sp_sps smb20">高層階に位置するワンランク上の<br class="onlySp">シングルルーム</h2>
                            <p class="tac sp_tal">
                                本館10～12階のエグゼクティブフロアに位置する、シングルルーム。<br>エアウィーヴマットレス、デュベタイプの寝具で快適な寝心地とマイクロナノバブルシャワーヘッド、<br class="onlyPc">こだわりのヘアドライヤー（ヘアビューザー）を設置しワンランク上のご滞在を提供いたします。<br>（禁煙ルームのみ）
                            </p>
                        </div>
                    </div>
                    <div class="ptb_sps pt60 spt40 spb20 inner_sb">
                        <article class="mb30 smb20">
                            ...
                            <dl class="dl_tnses_b">
                                ...
                                <dd>
                                    <div class="flex_left">
                                        <span class="pt4 mr15">19.5㎡</span>
                                        <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/executive-single/img_executive-single_layout.png" class="btn_floormap bg_gray a_md no_md_icon"><span>間取り図</span></a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="dl_tnses_b">
                            ...
                            <dl class="dl_tnses_b">
                                <dt>料金</dt>
                                <dd>1名様1室　16,650円～<br><span class="fs12">※表示価格は通常料金になり、税金・サービス料が含まれております。</span></dd>
                            </dl>
                        </article>
