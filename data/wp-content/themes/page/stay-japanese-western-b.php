                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m">
                        <h2 class="mttls tac mb18 smb12">
                            <span class="mttls_en en">JAPANESE-WESTERN ROOM B</span>
                            <span class="mttls_ja">和洋室Bタイプ</span>
                        </h2>
                        <div class="ptb_sps pt0 pb0 inner_sb sp_inner_b">
                            <div class="imgslidesA mb30 smb25">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-b/img_japanese-western-b1.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-b/img_japanese-western-b2.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-b/img_japanese-western-b3.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-b/img_japanese-western-b4.jpg" alt=""></figure>
                            </div>
                            <h2 class="read_ttl ja-min tac mb15 sp_sps smb20">大人数でも ゆったりとお寛ぎいただけます</h2>
                            <p class="tac sp_tal">
                                本館8～9階に位置する、5名定員の広めの和洋室。大きめの湯船が自慢のバスルーム、和室も8畳と広々。<br>
                                （全室禁煙ルームとなります）
                            </p>
                        </div>
                    </div>
                    <div class="ptb_sps pt60 spt40 spb20 inner_sb">
                        <article class="mb30 smb20">
                            ...
                            <dl class="dl_tnses_b">
                                ...
                                <dd>
                                    <div class="flex_left">
                                        ...
                                        <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-b/img_japanese-western-b_layout.png" class="btn_floormap bg_gray a_md no_md_icon"><span>間取り図</span></a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="dl_tnses_b">
                            ...
                            <dl class="dl_tnses_b">
                                <dt>料金</dt>
                                <dd>2名様1室　50,900円～<br><span class="fs12">※表示価格は通常料金になり、税金・サービス料が含まれております。</span></dd>
                            </dl>
                        </article>
                    ...
                    <div class="ptb_sps pt32 pb70 spb30 inner_sb">
                        ...
                        <article class="mdbtnset">
                            ...
                            <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-b/img_japanese-western-b5.jpg" class="a_md"><span><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-b/img_japanese-western-b5s.jpg" alt=""></span></a>
                        </article>
                    </div>
                </section>
