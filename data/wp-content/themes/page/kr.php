                    ...
                    <div class="ptb_sps pt0 pb120 spb60 inner_m">
                        <article class="bnr_container">
                            <div class="bnr_item bnr_item_m">
                                ...
                                <a href="<?php bloginfo('url'); ?>/kr/accommodations/" class="hitarea"></a>
                            </div>
                            <div class="bnr_item bnr_item_m">
                                ...
                                <a href="<?php bloginfo('url'); ?>/kr/restaurant/" class="hitarea"></a>
                            </div>
                            <div class="bnr_item bnr_item_s">
                                ...
                                <a href="<?php bloginfo('url'); ?>/kr/relaxation/" class="hitarea"></a>
                            </div>
                            <div class="bnr_item bnr_item_s">
                                ...
                                <a href="<?php bloginfo('url'); ?>/kr/company/" class="hitarea"></a>
                            </div>
                            <div class="bnr_item bnr_item_s">
                                ...
                                <a href="<?php bloginfo('url'); ?>/kr/access/" class="hitarea"></a>
                            </div>
