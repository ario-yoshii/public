            ...
            <div id="mainsections" class="main_inner">
                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb30 inner_m sp_inner_b">
						...
						<?php
							$chosen_idA = 66; $thisCatA = get_category($chosen_idA);
							$chosen_idB = 67; $thisCatB = get_category($chosen_idB);
							$chosen_idC = 68; $thisCatC = get_category($chosen_idC);
						...
						?>
							...
							<?php
								if ($thisCatA->count != 0 ) :?>
									<a href="<?php bloginfo('url'); ?>/info/restaurant/yumenokuni-lunch/" class="itbox_item">
										<div class="itbox_item_inner">
											<figure class="itbox_item_img">
												<img src="<?php bloginfo('template_directory'); ?>/assets/images/restaurant/yumenokuni/img_yumenokuni_lunch.jpg" alt=""/> </figure>
							...
							<?php
								if ($thisCatB->count != 0 ) :?>
									<a href="<?php bloginfo('url'); ?>/info/restaurant/yumenokuni-dinner/" class="itbox_item">
										<div class="itbox_item_inner">
											<figure class="itbox_item_img">
							...
							<?php
								if ($thisCatC->count != 0 ) :?>
									<a href="<?php bloginfo('url'); ?>/info/restaurant/yumenokuni-planning/" class="itbox_item">
										<div class="itbox_item_inner">
											<figure class="itbox_item_img">
                    ...
                    <div class="ptb_sps pb60 spb60 inner_m sp_inner_b">
                        ...
                        <article class="info_container mb30" data-maxview=6>
							...
							'category_name' => 'yumenokuni' // 表示したいカテゴリーのスラッグを指定
							);
							$posts = get_posts( $arg );
							if( $posts ): ?>
                        ...
                        <a href="<?php bloginfo('url'); ?>/info/restaurant/yumenokuni/" class="txtbtn mauto smt15"><span>夢の国の情報一覧</span></a>
                    </div>
                </section>
