<footer><!-- footer -->
    <div id="ft_content">
        <div class="inner">
            <h2 id="ft_logo"><a href="<?php bloginfo('url'); ?>/kr/"><img src="<?php bloginfo('template_directory'); ?>/assets/images/ft_logo.png" alt="HOTEL kyocera"></a></h2>
            <p id="ft_address">〒899-5117 일본 가고시마현 키리시마시 하야토쵸 미츠기 1409-1</p>
            ...
            <nav id="ft_txtbtns" class="btns mb30 smb20">
                <a href="<?php bloginfo('url'); ?>/kr/" class="txtbtn_normal"><span>Home</span></a>
