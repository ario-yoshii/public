<header><!-- header -->
    <div class="inner_b">
        <h2 id="hd_logo"><a href="<?php bloginfo('url'); ?>/kr/"><img src="<?php bloginfo('template_directory'); ?>/assets/images/hd_logo.png" alt="HOTEL KYOCERA"></a></h2>
        <nav id="gnavis">
            <div class="gnavi_item">
                <a href="<?php bloginfo('url'); ?>/kr/accommodations/" class="mm-target haslow"><span>객실</span></a>
            </div>
            <div class="gnavi_item">
                <a href="<?php bloginfo('url'); ?>/kr/restaurant/" class="mm-target haslow"><span>레스토랑 & 메인 바 소개</span></a>
            </div>
            <div class="gnavi_item">
                <a href="<?php bloginfo('url'); ?>/kr/relaxation/" class="mm-target haslow"><span>Relaxation</span></a>
            </div>
            <div class="gnavi_item">
                <a href="<?php bloginfo('url'); ?>/kr/company/" class="mm-target haslow"><span>호텔 소개</span></a>
            </div>
           <!-- <div class="gnavi_item">
            ...
            <div class="gnavi_item hd_onlyPc">
                ...
                <select name="" class="btn_language mm-target en" onchange="location.href=value;">
                    ...
                    <option label="한국어" value="<?php bloginfo('url'); ?>/kr/" selected>한국어</option>
        ...
        <div id="cvbox">
            ...
            <a href="<?php bloginfo('url'); ?>/kr/access/" class="accbtn hd_onlyPc"><span>오시는 길</span></a>
            ...
            <a href="<?php bloginfo('url'); ?>/kr/access/" class="hd_boxbtn sp_accbtn hd_onlyTb"><span>오시는 길</span></a>
        </div>
        <div id="revbox">
