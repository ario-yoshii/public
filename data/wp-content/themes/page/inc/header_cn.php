<header><!-- header -->
    <div class="inner_b">
        <h2 id="hd_logo"><a href="<?php bloginfo('url'); ?>/cn/"><img src="<?php bloginfo('template_directory'); ?>/assets/images/hd_logo.png" alt="HOTEL KYOCERA"></a></h2>
        <nav id="gnavis">
            <div class="gnavi_item">
                <a href="<?php bloginfo('url'); ?>/cn/accommodations/" class="mm-target haslow"><span>住宿</span></a>
            </div>
            <div class="gnavi_item">
                <a href="<?php bloginfo('url'); ?>/cn/restaurant/" class="mm-target haslow"><span>餐厅&酒吧</span></a>
            </div>
            <div class="gnavi_item">
                <a href="<?php bloginfo('url'); ?>/cn/relaxation/" class="mm-target haslow"><span>休闲</span></a>
            </div>
            <div class="gnavi_item">
                <a href="<?php bloginfo('url'); ?>/cn/company/" class="mm-target haslow"><span>关于我们</span></a>
            </div>
           <!-- <div class="gnavi_item">
                <a href="<?php bloginfo('url'); ?>/cn/access/" class="mm-target haslow"><span>Access</span></a>
            </div>-->
            <div class="gnavi_item hd_onlyPc">
                ...
                <select name="" class="btn_language mm-target en" onchange="location.href=value;">
                    ...
                    <option label="簡体中文" value="<?php bloginfo('url'); ?>/cn/" selected>簡体中文</option>
        ...
        <div id="cvbox">
            ...
            <a href="<?php bloginfo('url'); ?>/cn/access/" class="accbtn hd_onlyPc"><span>访问</span></a>
            ...
            <a href="<?php bloginfo('url'); ?>/cn/access/" class="hd_boxbtn sp_accbtn hd_onlyTb"><span>访问</span></a>
        </div>
        <div id="revbox">
