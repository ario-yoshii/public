                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m">
                        <h2 class="mttls tac mb18 smb12">
                            <span class="mttls_en en">JAPANESE-WESTERN ROOM A</span>
                            <span class="mttls_ja">和洋室Aタイプ</span>
                        </h2>
                        <div class="ptb_sps pt0 pb0 inner_sb sp_inner_b">
                            <div class="imgslidesA mb30 smb25">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-a/img_japanese-western-a1.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-a/img_japanese-western-a2.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-a/img_japanese-western-a3.jpg" alt=""></figure>
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-a/img_japanese-western-a4.jpg" alt=""></figure>

                            </div>
                            <h2 class="read_ttl ja-min tac mb15 sp_sps smb20">ご家族旅行、グループ旅行に最適</h2>
                            <p class="tac sp_tal">
                                本館7～9階に位置する、4名定員の和洋室。<br>
                                （全室禁煙となります）
                            </p>
                        </div>
                    </div>
                    <div class="ptb_sps pt60 spt40 spb20 inner_sb">
                        <article class="mb30 smb20">
                            ...
                            <dl class="dl_tnses_b">
                                ...
                                <dd>
                                    <div class="flex_left">
                                        <span class="pt4 mr15">38.7㎡　ツイン+4.5畳</span>
                                        <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-a/img_japanese-western-a_layout.png" class="btn_floormap bg_gray a_md no_md_icon"><span>間取り図</span></a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="dl_tnses_b">
                                <dt>ベッド幅</dt>
                                <dd>1,200mm 2台<br>(3名、4名利用時は和布団をご準備いたします)</dd>
                            </dl>
                            <dl class="dl_tnses_b">
                                <dt>フロア</dt>
                                <dd>本館7～9階</dd>
                            ...
                            <dl class="dl_tnses_b">
                                <dt>料金</dt>
                                <dd>2名様1室　37,700円～<br><span class="fs12">※表示価格は通常料金になり、税金・サービス料が含まれております。</span></dd>
                            </dl>
                        </article>
                    ...
                    <div class="ptb_sps pt32 pb70 spb30 inner_sb">
                        ...
                        <article class="mdbtnset">
                            <?php include(TEMPLATEPATH . '/inc/stay_inner1.php'); ?>
                            <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-a/img_japanese-western-a5.jpg" class="a_md"><span><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/japanese-western-a/img_japanese-western-a5s.jpg" alt=""></span></a>
                        </article>
                    </div>
                </section>
