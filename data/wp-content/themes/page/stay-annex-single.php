                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m">
                        ...
                        <div class="ptb_sps pt0 pb0 inner_sb sp_inner_b">
                            <div class="imgslidesA mb30 smb25">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/annex-single/img_annex-single1.jpg" alt=""></figure>
                            </div>
                            <h2 class="read_ttl ja-min tac mb15 sp_sps smb20">広めのライティングデスク・チェアがあり、<br class="onlySp">ビジネスに最適なお部屋です</h2>
                            <p class="tac sp_tal">
                                別館のコーナーシングルより広めのスタンダードタイプのシングルルーム。<br>
                                （禁煙ルームのみ）
                            </p>
                        </div>
                    </div>
                    <div class="ptb_sps pt60 spt40 spb20 inner_sb">
                        <article class="mb30 smb20">
                            ...
                            <dl class="dl_tnses_b">
                                ...
                                <dd>
                                    <div class="flex_left">
                                        ...
                                        <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/annex-single/img_annex-single_layout.png" class="btn_floormap bg_gray a_md no_md_icon"><span>間取り図</span></a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="dl_tnses_b">
                            ...
                            <dl class="dl_tnses_b">
                                <dt>料金</dt>
                                <dd>1名様1室　13,350円～<br><span class="fs12">※表示価格は通常料金になり、税金・サービス料が含まれております。</span></dd>
                            </dl>
                        </article>
