<?php
/*
Template Name: ご宿泊 - スタンダードツイン 本館
*/
?>
<?php get_header(); ?>
                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m">
                        ...
                        <div class="ptb_sps pt0 pb0 inner_sb sp_inner_b">
                            <div class="imgslidesA mb30 smb25">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/twin/img_twin1.jpg" alt=""></figure>
                            </div>
                            <h2 class="read_ttl ja-min tac mb15 sp_sps smb20">29平米の広さでゆったりとお寛ぎいただけます</h2>
                            <p class="tac sp_tal">
                                本館4～9階にございますスタンダードツインルーム。<br>
                    ...
                    <div class="ptb_sps pt60 spt40 spb20 inner_sb">
                        <article class="mb30 smb20">
                            ...
                            <dl class="dl_tnses_b">
                                ...
                                <dd>
                                    <div class="flex_left">
                                        ...
                                        <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/twin/img_twin_layout.png?20210614" class="btn_floormap bg_gray a_md no_md_icon"><span>間取り図</span></a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="dl_tnses_b">
                            ...
                            <dl class="dl_tnses_b">
                                <dt>料金</dt>
                                <dd>2名様1室　27,800円～<br><span class="fs12">※表示価格は通常料金になり、税金・サービス料が含まれております。</span></dd>
                            </dl>
                        </article>
