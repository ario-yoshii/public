                ...
                <section class="content">
                    ...
                    <div class="mb120 smb60 inner">
                        ...
                        <p class="tac fs16 sfs14 mb10 mt40">
                            ...
                            <h3 class="tellno_b en mb20 smb15 tac"><?php if (is_mobile()) : ?><a href="tel:0995-43-7676" onclick="gtag('event', 'tel-tap', {'event_category':'click','event_label': 'restaurant'});">TEL 0995-43-7676</a><?php else: ?>TEL 0995-43-7676<?php endif; ?></h3>
                    </div>
                </section>
