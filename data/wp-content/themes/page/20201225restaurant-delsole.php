                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb30 inner_m sp_inner_b">
						...
						?>
							...
							<?php
								if ($thisCatA->count != 0 ) :?>
									<a href="<?php bloginfo('url'); ?>/info/restaurant/delsole/delsole-lunch/" class="itbox_item">
							...
							<?php
								if ($thisCatB->count != 0 ) :?>
									<a href="<?php bloginfo('url'); ?>/info/restaurant/delsole/delsole-dinner/" class="itbox_item">
										<div class="itbox_item_inner">
											<figure class="itbox_item_img">
							...
							<?php
								if ($thisCatC->count != 0 ) :?>
									<a href="<?php bloginfo('url'); ?>/info/restaurant/delsole/delsole-planning/" class="itbox_item">
										<div class="itbox_item_inner">
											<figure class="itbox_item_img">
                    ...
                    <div class="ptb_sps pb60 spb60 inner_m sp_inner_b">
                        ...
                        <a href="<?php bloginfo('url'); ?>/info/restaurant/delsole/" class="txtbtn mauto smt15"><span>デルソーレの情報一覧</span></a>
                    </div>
                </section>
