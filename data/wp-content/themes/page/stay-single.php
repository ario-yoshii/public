                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb0 inner_m">
                        <h2 class="mttls tac mb18 smb12">
                            ...
                            <span class="mttls_ja">シングルルーム</span>
                        </h2>
                        <div class="ptb_sps pt0 pb0 inner_sb sp_inner_b">
                            <div class="imgslidesA mb30 smb25">
                                <figure><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/single/img_single1.jpg" alt=""></figure>
                            </div>
                            <h2 class="read_ttl ja-min tac mb15 sp_sps smb20">広めのライティングデスク・チェアがあり、<br class="onlySp">ビジネスに最適なお部屋です</h2>
                            <p class="tac sp_tal">
								本館4～10階にございますスタンダードタイプのシングルルーム。<br class="onlyPc">
								エアウィーヴマットレスで快適な寝⼼地をお約束します。<br>
								（禁煙ルームのみ）
                            </p>
                        </div>
                    </div>
                            ...
                            <dl class="dl_tnses_b">
                                ...
                                <dd>
                                    <div class="flex_left">
                                        ...
                                        <a href="<?php bloginfo('template_directory'); ?>/assets/images/stay/single/img_single_layout.png" class="btn_floormap bg_gray a_md no_md_icon"><span>間取り図</span></a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="dl_tnses_b">
