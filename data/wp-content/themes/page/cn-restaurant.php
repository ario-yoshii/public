    ...
    <main id="maincontainer" class="container"><!-- #maincontainer -->
        ...
        <div class="main_bloc">
            ...
            <section id="lkv" data-image="<?php bloginfo('template_directory'); ?>/assets/images/restaurant/lkv_img_restaurant_bar@2x.jpg"><!-- #kv -->
                <h1 class="lkv_bttls">
                    <span class="mttls_en en">餐厅&酒吧</span>
                </h1>
            </section><!-- /#kv -->
                ...
                <section class="content">
                    <div class="inner_m bd_btm">
                        <div class="ptb_sps pt0 pb80 spb40 inner_sb sp_inner_b">
                            ...
                            <p class="tac sp_tal">
							本酒店竭诚为您奉上严选食材、制作精细的时令美味，独一无二的当地海鲜、黑猪黑牛、蔬果时令等日式、西式、中式、自助及独创菜肴，令您置身品味当地美食、享受一流服务的旅途乐趣。
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="imgbox_typeC">
                                    ...
                                    <div class="itd_item_inner mb80 smb40">
                                        ...
                                        <div class="itd_item_tbox_en">
                                            <h2 class="read_ttl_en en">
                                                <span class="read_stl">主馆 1楼</span>
                                                牛排和自助餐 休间吧
                                            </h2>
                                            <p class="read_txt line pb20">
											阳光从60米高的大堂天井倾泻而下，洒满开放宽阔的酒店大厅，窗外眼前“天降川”的波光、“雾岛山”的绿影如同一幅巨大的风景，置身其中，沐浴着清晨朝霞、午后阳光、或夜晚星辉享受着早餐、午餐、下午茶、或晚餐，多么惬意闲适
                                            </p>
                                ...
                                <div class="itd_item">
                                    <div class="itd_item_inner mb80 smb40">
                                        ...
                                        <div class="itd_item_tbox_en">
                                            <h2 class="read_ttl_en en">
                                                <span class="read_stl">主馆 3楼</span>
                                                日本料理 京春华
                                            </h2>
                                            <p class="read_txt line pb20">
											京春华尽显日本料理传统与美味，让您在安静祥和的氛围中体会萨摩的食材与多彩季节，感受独创菜品的芸术气息与周到心意，品味鹿儿岛烧酒及严选的日本酒。
                                            </p>
                                            <dl class="openhours openhours_en">
                                                <dt>营业时间</dt>
                                                <dd>
                                ...
                                <div class="itd_item">
                                    <div class="itd_item_inner mb80 smb40">
                                        ...
                                        <div class="itd_item_tbox_en">
                                            <h2 class="read_ttl_en en">
                                                <span class="read_stl">主馆 13楼</span>
                                                Main bar Amore
                                            </h2>
                                            <p class="read_txt line pb20">
												南国星空之下，在美丽夜景之中，上演成熟故事。从酒店最高层透过前方的巨大玻璃窗一边欣赏迷人的夜色，一边品味红酒、烧酒及専为您调制的鸡尾酒等各色美酒，多么惬意。
                                            </p>
                                            <dl class="openhours">
                                                <dt>营业时间</dt>
                                                <dd>
                                ...
                                <div class="itd_item">
                                    <div class="itd_item_inner mb80 smb40">
                                        ...
                                        <div class="itd_item_tbox_en">
                                            <h2 class="read_ttl_en en">
                                                <span class="read_stl">别馆 1楼</span>
                                                自助式餐厅梦乡
                                            </h2>
                                            <p class="read_txt line pb20">
												柔和明亮的自然光撒落开放而闲适的空间，犹如进入梦乡、邀您尽情享用各种充满能量、带来感动、洋式和日式兼收的美味，女性们喜爱的甜点及鹿儿岛烧酒。
                                            </p>
                                            <dl class="openhours openhours_en">
                                                <dt>营业时间</dt>
                                                <dd>
