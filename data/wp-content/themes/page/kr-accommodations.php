<?php
/*
Template Name: 韓国語 - ACCOMMODATIONS
*/
?>
<?php get_header(); ?>
    ...
    <main id="maincontainer" class="container"><!-- #maincontainer -->
        ...
        <div class="main_bloc">
            ...
            <section id="lkv" data-image="<?php bloginfo('template_directory'); ?>/assets/images/stay/lkv_img_stay@2x.jpg"><!-- #kv -->
                <h1 class="lkv_bttls">
                    <span class="mttls_en en">객실</span>
                </h1>
            </section><!-- /#kv -->
            ...
            <div id="mainsections" class="main_inner">
                ...
                <article id="breadcrumb" class="ja-serif"><!-- #breadcrumb -->
                  <div id="breadcrumb_inner" class="inner_m">
                    <p>
                        <a href="<?php bloginfo('url'); ?>/kr/">Home</a>
                ...
                <section class="content">
                    <div class="inner_m bd_btm">
                        <div class="ptb_sps pt0 pb80 spb40 inner_sb sp_inner_b">
                            ...
                            <p class="tac sp_tal">
							가고시마의 수려한 자연과 어우러진 328실의 다양한 객실 .<br>
							기품 있는 아이보리와 화이트 톤의 인테리어가 조화를 이룬 객실내부는 마치 내 집에 있는 듯한 안락함과 쾌적함을 느끼게 합니다.
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="room_points_container">
                            <article id="room_points_item01" class="room_points_item">
                                <div class="room_points_item_inner">
                                    <h4 class="room_points_ttl en">객실수: 328실</h4>
                                    <p>금연 객실: 245실</p>
                                </div>
                            </article>
                            ...
                            <article id="room_points_item03" class="room_points_item">
                                <div class="room_points_item_inner">
                                    <h4 class="room_points_ttl en">가습기 겸용 공기청정기 전 객실완비</h4>
                                    <p>보다 더 쾌적한 실내환경 속에서 머무르실 수 있습니다.</p>
                                </div>
                            </article>
                        </div>
                    </section>
                            ...
                            <article>
                                <div class="imgbox_typeD">
                                    ...
                                    <dl class="imgbox_dlset">
                                        <dt>SINGLE</dt>
                                        <dd>스마트하고 심플한 공간에 세미더블 침대와 사무용 책상을 배치한 싱글 룸.<br>
											업무의 피로를 해소하는 쾌적함과 안락함으로 고객님의 성공적인 비즈니스를 서포트합니다.</dd>
                                    </dl>
                                </div>
                                <div class="imgbox_typeD">
                                    ...
                                    <dl class="imgbox_dlset">
                                        <dt>TWIN & TRIPLE</dt>
                                        <dd>탁 트인 넓은 공간이 매력적인 트윈 룸.<br>
											관광, 비즈니스 등 다용도로 활용 가능한 트윈 룸은 고객께 한층 높은 안락한 휴식을 선사합니다. 최대 3인 이용 가능한 디럭스 트윈도 비치되어 있습니다.</dd>
                                    </dl>
                                </div>
                                <div class="imgbox_typeD">
                                    ...
                                    <dl class="imgbox_dlset">
                                        <dt>SUITE</dt>
                                        <dd>가고시마의 상징「사쿠라지마」를 중심으로 웅장한 경관을 조망할 수 있는 스위트 룸.<br>
											귀빈을 맞이하는 최상의 객실답게 최고의 안락함과 편안함을 선사합니다.<br>
											<br>
											※스위트 룸은 응접실, 침실, 자쿠지, 욕실, 간이부엌이 완비되어 있습니다.<br>
											(단, 자쿠지는 로얄 스위트에만 해당)</dd>
                                    </dl>
                                </div>
                            </article>
                        </div>
