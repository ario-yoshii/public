<?php
/*
Template Name: 韓国語 - RESTAURANT&BAR
*/
?>
<?php get_header(); ?>
    ...
    <main id="maincontainer" class="container"><!-- #maincontainer -->
        ...
        <div class="main_bloc">
            ...
            <section id="lkv" data-image="<?php bloginfo('template_directory'); ?>/assets/images/restaurant/lkv_img_restaurant_bar@2x.jpg"><!-- #kv -->
                <h1 class="lkv_bttls">
                    <span class="mttls_en en">레스토랑 & 메인 바 소개</span>
                </h1>
            </section><!-- /#kv -->
                ...
                <section class="content">
                    <div class="inner_m bd_btm">
                        <div class="ptb_sps pt0 pb80 spb40 inner_sb sp_inner_b">
                            ...
                            <p class="tac sp_tal">
								현지에서 맛보는 향토음식은 여행의 묘미 중 하나입니다.<br>
								본 호텔의 요리는 엄선된 제철 식재료로 정성껏 식탁에 올리고 있습니다. 일식, 양식, 중식, 뷔페 등 각 레스토랑의 요리장이 선보이는 깊고 풍부한 맛과 배려 깊은 직원의 세심한 서비스는 고객께 더 큰 감동을 선사합니다.
                            </p>
                        </div>
                    </div>
                                ...
                                <div class="itd_item">
                                    <div class="itd_item_inner mb80 smb40">
                                        ...
                                        <div class="itd_item_tbox_en">
											...
											지상 60m자연채광이 환히 비추는 호텔 쿄세라의 자랑인 아트리움 안에 위치한「데루소레」.
											넓은 오픈 공간과 유리돔 밖으로 펼쳐지는 아모리강과 키리시마 연산의 전망이 근사한 데루소레는 아침부터 점심, 오후의 티타임 그리고 저녁까지 럭셔리한 고품격의 분위기를 선사하는 카페 & 다이닝 레스토랑입니다.
                                            </p>
                                ...
                                <div class="itd_item">
                                    <div class="itd_item_inner mb80 smb40">
                                        ...
                                        <div class="itd_item_tbox_en">
                                            ...
                                            <p class="read_txt line pb20">
												일본에서만 접할 수 있는 전통적인 분위기와 맛, 소재와 멋을 담은 「쿄 하루카」. 아늑하고 단아한 분위기 속에서 엄선된 가고시마산 식재료를 사용한 계절감 넘치는 요리와 요리장이 손수 담아내는 예술요리를 마음껏 즐겨 보십시오. 엄선된 가고시마 소주와 일본사케도 갖추 어져 있습니다.
                                            </p>
                                            <dl class="openhours openhours_en">
                                                <dt>OPEN</dt>
                                                <dd>
                                ...
                                <div class="itd_item">
                                    <div class="itd_item_inner mb80 smb40">
                                        ...
                                        <div class="itd_item_tbox_en">
                                            ...
                                            <p class="read_txt line pb20">
											아름다운 야경이 로맨틱한 분위기를 더하는「바 아모레」<br>
											밤하늘의 별빛과 어우러진 아트리움이 훤히 내려다 보이는 근사한 밤을 프로 바텐더가 선보 이는 칵테일에 푹 빠져 감상해 보십시오.
                                            </p>
                                            <dl class="openhours">
                                                <dt>OPEN</dt>
                                                <dd>
                                ...
                                <div class="itd_item">
                                    <div class="itd_item_inner mb80 smb40">
                                        ...
                                        <div class="itd_item_tbox_en">
                                            ...
                                            <p class="read_txt line pb20">
												자연채광이 내부를 환히 밝혀주는 캐쥬얼한 레스토랑「유메노쿠니」.<br>
												맛의 감동이 느껴지는 스태미나 요리들로 가득찬 유메노쿠니에서 풍요로운 식감을 느껴보십 시오. 여성에게 인기 있는 디저트와 여러 종류의 가고시마 소주도 갖추어져 있습니다.
                                            </p>
                                            <dl class="openhours openhours_en">
                                                <dt>OPEN</dt>
                                                <dd>
