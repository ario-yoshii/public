...
<div id="wrapper"><!-- #wrapper -->
    ...
    <main id="maincontainer" class="container"><!-- #maincontainer -->
        ...
        <div class="main_bloc">
			...
			<?php elseif(in_category('delsole')||in_category('delsole-lunch')||in_category('delsole-dinner')||in_category('delsole-planning')) : ?>
			...
			<?php elseif(in_category('kyoharuka')||in_category('kyoharuka-lunch')||in_category('kyoharuka-dinner')||in_category('kyoharuka-planning')) : ?>
			...
			<?php elseif(in_category('amore')||in_category('amore-planning')) : ?>
			...
			<?php elseif(in_category('yumenokuni')||in_category('yumenokuni-lunch')||in_category('yumenokuni-dinner')||in_category('yumenokuni-drink')) : ?>
			...
			<?php elseif(in_category('banquet')) : ?>
			...
			<?php elseif(in_category('relaxation')) : ?>
                  ...
                  <div id="breadcrumb_inner" class="inner_m">
                    <p>
						...
						<?php if(in_category('restaurant')) : ?>
							...
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/restaurant/">インフォメーション</a>
						<?php elseif(in_category('delsole')) : ?>
							<a href="<?php bloginfo('url'); ?>/restaurant/">レストラン＆バー</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
						...
						<?php elseif(in_category('delsole-lunch')) : ?>
							...
							<a href="<?php bloginfo('url'); ?>/info/restaurant/delsole/">インフォメーション</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/restaurant/delsole/delsole-lunch/">ランチメニュー</a>
						<?php elseif(in_category('delsole-dinner')) : ?>
							...
							<a href="<?php bloginfo('url'); ?>/info/restaurant/delsole/">インフォメーション</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/restaurant/delsole/delsole-dinner/">ディナーメニュー</a>
						<?php elseif(in_category('delsole-planning')) : ?>
							...
							<a href="<?php bloginfo('url'); ?>/info/restaurant/delsole/">インフォメーション</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/restaurant/delsole/delsole-planning/">企画商品</a>
						<?php elseif(in_category('kyoharuka')) : ?>
							<a href="<?php bloginfo('url'); ?>/restaurant/">レストラン＆バー</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
						...
						<?php elseif(in_category('kyoharuka-dinner')) : ?>
							...
							<a href="<?php bloginfo('url'); ?>/info/restaurant/kyoharuka/">インフォメーション</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/restaurant/kyoharuka/kyoharuka-dinner/">夕食メニュー</a>
						<?php elseif(in_category('kyoharuka-planning')) : ?>
							...
							<a href="<?php bloginfo('url'); ?>/info/restaurant/kyoharuka/">インフォメーション</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/restaurant/kyoharuka/kyoharuka-planning/">企画商品</a>
						<?php elseif(in_category('amore')) : ?>
							<a href="<?php bloginfo('url'); ?>/restaurant/">レストラン＆バー</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
						...
						<?php elseif(in_category('amore-planning')) : ?>
							...
							<a href="<?php bloginfo('url'); ?>/info/restaurant/amore/">インフォメーション</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/restaurant/amore/amore-planning/">企画商品</a>
						<?php elseif(in_category('yumenokuni')) : ?>
							<a href="<?php bloginfo('url'); ?>/restaurant/">レストラン＆バー</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/restaurant/yumenokuni/">バイキングレストラン 夢の国</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/restaurant/yumenokuni/">インフォメーション</a>
						<?php elseif(in_category('yumenokuni-lunch')) : ?>
							...
							<a href="<?php bloginfo('url'); ?>/info/restaurant/kyoharuka/">インフォメーション</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/restaurant/yumenokuni/yumenokuni-lunch/">ランチメニュー</a>
						<?php elseif(in_category('yumenokuni-dinner')) : ?>
							...
							<a href="<?php bloginfo('url'); ?>/info/restaurant/kyoharuka/">インフォメーション</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/restaurant/yumenokuni/yumenokuni-dinner/">ディナーメニュー</a>						
						<?php elseif(in_category('yumenokuni-drink')) : ?>
							<a href="<?php bloginfo('url'); ?>/restaurant/">レストラン＆バー</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/restaurant/yumenokuni/">バイキングレストラン 夢の国</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/restaurant/kyoharuka/">インフォメーション</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/restaurant/yumenokuni/yumenokuni-drink/">ドリンクメニュー</a>
						<?php elseif(in_category('stay')) : ?>
                       		<a href="<?php bloginfo('url'); ?>/stay/">ご宿泊</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/stay/">インフォメーション</a>						
						<?php elseif(in_category('stay_plan')) : ?>
                       		<a href="<?php bloginfo('url'); ?>/stay/">ご宿泊</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
						...
						<?php elseif(in_category('banquet')) : ?>
							...
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/banquet/">インフォメーション</a>							
						<?php elseif(in_category('relaxation')) : ?>
                       		<a href="<?php bloginfo('url'); ?>/relaxation/">温泉・スパ・プール・ジム</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/relaxation/">インフォメーション</a>	
						<?php elseif(in_category('shop')) : ?>
                       		<a href="<?php bloginfo('url'); ?>/shop/">ショップ</a>
							<span class="bcsps">&nbsp;&gt;&nbsp;</span>
							<a href="<?php bloginfo('url'); ?>/info/shop/">インフォメーション</a>	
