                ...
                <section class="content">
                    <div class="ptb_sps pt0 pb30 inner_m sp_inner_b">
						...
						?>
							...
							<?php
								if ($thisCatA->count != 0 ) :?>
									<a href="<?php bloginfo('url'); ?>/info/restaurant/amore/amore-planning/" class="itbox_item">
										<div class="itbox_item_inner">
											...
											<h3 class="itbox_item_ttl ja-min">企画商品</h3>
                    ...
                    <div class="ptb_sps pb60 spb60 inner_m sp_inner_b">
                        ...
                        <a href="<?php bloginfo('url'); ?>/info/restaurant/amore/" class="txtbtn mauto smt15"><span>アモーレの情報一覧</span></a>
                    </div>
                </section>
