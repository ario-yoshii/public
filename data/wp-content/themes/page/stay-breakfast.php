                                ...
                                <div class="imgbox_typeC">
                                    <div class="itd_item">
                                        <div class="itd_item_inner">
                                            <figure class="mb15"><img src="<?php bloginfo('template_directory'); ?>/assets/images/stay/breakfast/202307_img_appeal01.jpg" alt=""></figure>
                                            <div class="itd_item_tbox">
                                                <h2 class="read_ttl ja-min">ホテルオリジナル黒カレー</h2>
                                                <p class="read_txt">朝の目覚めにピリッと癖になる辛さのホテルオリジナル黒カレーがお勧めです。</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="itd_item">
                                    ...
                                    <div class="id_tbox_inner">
                                        ...
                                        <article class="">
                                            ...
                                            <dl class="dl_tnses">
                                                <dt class="pt15">会場</dt>
                                                <dd class="pt15">
                                                    <div class="flex_left">別館１階 夢の国<!--<a href="#" class="btn_floormap nmt5 ml15"><span>フロアマップ</span></a>--></div>
                                                </dd>
                                            </dl>
                                            <dl class="dl_tnses">
                                                <dt>ご提供時間</dt>
